...
add_user_to_video() {
	...
	chown $VUSER /home/$VUSER
	for dir in Desktop Downloads .config Documents Music Pictures ; do
	   test -e /home/$VUSER/$dir || mkdir /home/$VUSER/$dir 
        done
}
...
dialog --title "Rolling Release" --yesno "Change pkg to use 'latest' packages instead of quarterly? This prevents potential missing firefox package in 13.1 quarterly - not generally recommended" 0 0
